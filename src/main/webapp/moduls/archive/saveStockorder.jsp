...
货物管理->进货单->新增
    <hr/>
    <br>
    <s:form action="stockorderAction_saveStockorder" method="post" onSubmit="return checkForm()" theme="simple">
        <table align="center"   >
			<tr>
				<td >订单编号</td>
				<td>
				    <s:textfield name="stockorder.code" id="code" onblur="checkCode()"/>
				</td>
